...
public class GameFieldPlayerOne extends AppCompatActivity {
        ...
        private FirebaseGameController firebaseController;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_game_field_player_one);
                    ...
                    if ((TURN & WHITETURN) != 0) {
                        if(whiteQueen.checkIfIsQueen(v)){
                            ...
                            if(posForWhiteQueen.size()<=0) {
                                ...
                                posForWhiteQueen = whiteQueen.getPositionsToMove(row, col);
            ...
            firebaseController = new FirebaseGameController(stones, gameName);
            firebaseController.initStartSituation();
